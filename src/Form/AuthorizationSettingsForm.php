...
/**
 * @file
 * Contains \Drupal\authorization\AuthorizationSettingsForm
 */
...
class AuthorizationSettingsForm extends ConfigFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    ->set('authorization_message_on', $form_state->getValue('authorization_message'))
    ->save();
