...
/**
 * @file
 * Contains \Drupal\authorization\Plugin\AuthorizationAPIProviderManager.
 */
 ...
 */
class AuthorizationAPIProviderManager extends DefaultPluginManager {

  /**
   * Constructor for AuthorizationAPIProviderManager objects.
   *
